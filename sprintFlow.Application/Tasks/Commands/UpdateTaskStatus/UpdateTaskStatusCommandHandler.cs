...
public class UpdateTaskStatusCommandHandler(ITaskRepository taskRepository, IMapper mapper, IUserContext userContext) : IRequestHandler<UpdateTaskStatusCommand, Result<Guid>>
{
