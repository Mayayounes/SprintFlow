...
public class UpdateTaskDetailsCommandHandler(IUserContext userContext, IMapper mapper, IProjectRepository projectRepository, ITaskRepository taskRepository, IUserRepository userRepository) : IRequestHandler<UpdateTaskDetailsCommand, Result<Guid>>
{
