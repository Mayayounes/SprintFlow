...
public class CreateProjectCommandHandler(IUserContext userContext, IMapper mapper, IProjectRepository projectRepository) : IRequestHandler<CreateProjectCommand, Guid>
{
